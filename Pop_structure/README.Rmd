...
According to [Meisner and Albrechtsen](10.1534/genetics.118.30133), the best K is determined by 1+ D (the optimal number of principal components). As presented in Supplementary Fig. 2 in the paper, D would be equal to 5 (determined by the elbow (broken-stick) method), so K=6.
...
According to [Meisner and Albrechtsen](10.1534/genetics.118.30133), the best K is determined by 1+ D (the optimal number of principal components). D would be equal to 1 (determined by the elbow (broken-stick) method), so K=2.
