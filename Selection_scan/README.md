...
Calculate the FST for 3 populations. We need the simium samples. The 2
others populations can be : Colombia and Brazil.

Here I show the code only for the cluster RJ, but it is the same with
SP.
